...
class OpenImage():
    ...
    def __init__(self, root, dataset='train', transform=None, target_transform=None, imgview=False, src_subdir=None):
        ...
        if src_subdir is not None:
            self.path = os.path.join(self.processed_folder, src_subdir)
        else:
