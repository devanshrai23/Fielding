...
# Verified against https://github.com/Liangqiong/ViT-FL-main/blob/main/models/modeling.py
...
def vit_base_patch16_224(pretrained=False, **kwargs):
    ...
    logging.info("using vit_base_patch16_224, model_kwargs: {}".format(model_kwargs))
    return model
