...
parser.add_argument('--client_start_end_rounds_file', type=str, default=None)
parser.add_argument('--default_global_recluster', type=bool, default=False)
parser.add_argument('--force_incremental', type=bool, default=False)
parser.add_argument('--global_recluster_thres_ratio', type=float, default=3)
parser.add_argument('--use_global_model', type=bool, default=False)
parser.add_argument('--split_round', type=int, default=1)
parser.add_argument('--run_epochs', type=bool, default=False)
parser.add_argument('--adjust_cluster_selected_num', type=bool, default=False)
parser.add_argument('--recluster_at_drift', type=bool, default=False)
parser.add_argument('--num_cluster', type=int, default=1)
parser.add_argument('--min_num_cluster', type=int, default=2)
...
# for records keeping
parser.add_argument('--dump_per_client_accuracy', type=bool, default=False)
...
parser.add_argument('--checkpoint_dir', type=str, default='./workspace/checkpoint')
...
parser.add_argument('--test_client_ratio', type=float, default=1.0)
...
datasetCategories = {'Mnist': 10, 'cifar10': 10, "imagenet": 1000, 'emnist': 47, 'fmow': 62,
                     'openImg': 100, 'google_speech': 35, 'femnist': 62, 'yelp': 5,
